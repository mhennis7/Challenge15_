...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        SL = get_slots(intent_request)

    
        Validation_Res = validate_data(age, investment_amount, intent_request)
        ...
        out_attributes = intent_request["sessionAttributes"]

        return delegate(out_attributes, get_slots(intent_request))
